...
const AddService = () => {
    ...
    async function get()
    {
        try{
            ...
            const {data}=await axios.get(`https://jsr-backend-x7rr.onrender.com/Service/${id}`)
            setA(data);
        }
        catch(e)
        {
 ...
 get();
  ...
  const addService = async() => {
    // console.log(a);
    const apiURL = `https://jsr-backend-x7rr.onrender.com/Service/${id}`;
    axios
      .put(apiURL, a)
      .then(() => {
      navigate('/services');
          ...
          <div className="mt-2">
              <button
                ...
                onClick={() => {
                        ...
                        if(a.mainHeading != "" && a.subHeading1 && a.subHeading2 != "" && a.subHeading3 != "" && a.desc != "" && a.desc1 != "" && a.desc2 != "" && a.desc3 != "")
                       {addService();
